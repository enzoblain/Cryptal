...
fn sha256_known_phrase_no_dot() {
    ...
    expect_sha256_eq(b"The quick brown fox jumps over the lazy dog", &qbf_out);
}

#[test]
fn sha256_known_phrase_dot() {
    let qbf_dot_out: U256 = U256::from([
...
fn sha256_long_message_multiblock() {
    ...
    expect_sha256_eq(input, &long_out);
}
