...
Thank you for considering contributing to **Cryptography**!  
...
```
git clone https://github.com/enzoblain/cryptography.git
cd cryptography
```  
...
Every bug report, PR, and suggestion helps make **cryptography** better and more robust.
